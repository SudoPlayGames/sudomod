 ...
 */
public class FileSystemCandidateProvider implements
    ICandidateProvider {

  private static final Logger LOG = LoggerFactory.getLogger(FileSystemCandidateProvider.class);
  ...
  public FileSystemCandidateProvider(
