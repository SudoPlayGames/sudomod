...
public class DependencyContainerListMapperTest {
  ...
  public void getDependencyContainerListShouldReturnContainerList() throws Exception {
    ...
    Container containerA = new Container(null, null, null, null, null, null);
    Container containerB = new Container(null, null, null, null, null, null);
    Container containerC = new Container(null, null, null, null, null, null);
